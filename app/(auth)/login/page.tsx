...
function LoginForm() {
  ...
  const handleSelectProfile = (p: UserProfile) => {
    ...
    setSelectedUser({ ...p, initials })
    setEmail(p.email)
    setPassword('')
    setError('')
    setLoginMode('profile-password')
  }
        ...
        {loginMode === 'select' && (
          <div className="w-full max-w-4xl text-center animate-fadeIn cursor-default" onPointerDown={(e) => e.stopPropagation()} onClick={(e) => e.stopPropagation()}>
                  ...
                  >
                    ...
                    <div className="w-20 h-20 rounded-full bg-white/10 border border-white/20 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300 overflow-hidden relative shadow-md">
                      {p.avatarUrl ? (
                        ...
                        <span className="text-white font-mono text-lg font-bold tracking-wider group-hover:text-blue-300 transition-colors">
                          {initials}
                        </span>
                      )}
                    </div>
            ...
            <button
              ...
              className="text-white/40 hover:text-white font-mono text-xs uppercase tracking-[0.25em] transition-colors border-b border-white/10 hover:border-white/40 pb-1"
            >
              ...
              <div className="space-y-2 text-left">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-4 py-3 text-[15px] text-white bg-white/5 border border-white/10 focus:border-white/30 focus:bg-white/10 outline-none transition-all rounded-none placeholder:text-white/20 font-mono text-center"
                  />
                  <button
                    type="button"
          ...
          <div className="w-full max-w-[380px] bg-white/5 backdrop-blur-xl border border-white/10 p-8 shadow-2xl relative animate-fadeIn cursor-default" onPointerDown={(e) => e.stopPropagation()} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center mb-8 text-left">
              ...
              <p className="text-white/40 font-mono text-[10px] uppercase tracking-widest mt-1">
                Enter target credentials below
              </p>
            </div>
